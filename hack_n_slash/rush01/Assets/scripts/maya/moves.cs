...
public class moves : MonoBehaviour {
	...
	void Update () {
		if (GetComponent<stats> ().isDie) {
			...
			if ((Input.GetKeyDown (KeyCode.Mouse0) || Input.GetKey (KeyCode.Mouse0)) && GetComponent<attack>().focusEnemy == null && UnityEngine.EventSystems.EventSystem.current.IsPointerOverGameObject () == false) {
